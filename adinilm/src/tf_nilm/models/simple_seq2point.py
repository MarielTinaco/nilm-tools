...
def create_resnet_model(input_window_length):
        ...
        conv1 = keras.layers.Conv2D(filters=32, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(reshape_layer)
        conv1 = keras.layers.BatchNormalization()(conv1)
        conv2 = keras.layers.Conv2D(filters=32, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(conv1)
        conv2 = keras.layers.BatchNormalization()(conv2)
        conv3 = keras.layers.Conv2D(filters=32, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(conv2)
        resid_1 = keras.layers.Add()([conv2, conv3])
        resid_1 = keras.layers.ReLU()(resid_1)
        resid_1 = keras.layers.BatchNormalization()(resid_1)

        conv4 = keras.layers.Conv2D(filters=48, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(resid_1)
        conv4 = keras.layers.BatchNormalization()(conv4)
        conv5 = keras.layers.Conv2D(filters=48, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(conv4)
        conv5 = keras.layers.BatchNormalization()(conv5)
        conv5 = keras.layers.MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same')(conv5)
        conv6 = keras.layers.Conv2D(filters=48, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(conv5)
        ...
        conv7 = keras.layers.Conv2D(filters=64, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(resid_2)
        conv7 = keras.layers.BatchNormalization()(conv7)
        conv8 = keras.layers.Conv2D(filters=64, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(conv7)
        conv8 = keras.layers.BatchNormalization()(conv8)
        conv8 = keras.layers.MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same')(conv8)
        conv9 = keras.layers.Conv2D(filters=64, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(conv8)
        ...
        conv10 = keras.layers.Conv2D(filters=96, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(resid_3)
        conv10 = keras.layers.BatchNormalization()(conv10)
        conv11 = keras.layers.Conv2D(filters=96, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(conv10)
        ...
        conv12 = keras.layers.Conv2D(filters=96, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(conv11)
        ...
        conv13 = keras.layers.Conv2D(filters=128, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(resid_4)
        ...
        conv14 = keras.layers.Conv2D(filters=96, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(conv13)
        conv14 = keras.layers.BatchNormalization()(conv14)

        conv15 = keras.layers.Conv2D(filters=64, kernel_size=(3, 1), strides=(1, 1), padding="same", activation="relu")(conv14)
        conv15 = keras.layers.BatchNormalization()(conv15)

        flatten_layer = keras.layers.Flatten()(conv15)
        
        label_layer = keras.layers.Dense(256, activation="relu")(flatten_layer)
        output_layer_1 = keras.layers.Dense(2*5, activation="linear", name="y1_output")(label_layer)
        output_layer_2 = keras.layers.Dense(5*5, activation="linear", name="y2_output")(label_layer)

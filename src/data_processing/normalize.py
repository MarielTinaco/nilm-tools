...
class NormalizationContext(object):
    ...
    def __init__(self, 
                 strategy: Optional[Union["NormalizeStrategy", str]] = None):

        if strategy is None:
            strategy = MinMaxScaling(data)
        
        elif isinstance(strategy, str):
            strategy = NormalizationProfiles[NormalizationType(strategy)](data)
...
class StandardScaling(NormalizeStrategy):
    ...
    def __init__(self, std_val, std_val):
        self.std = std_val
        self.mean = mean_val
